...
const TABS = [
  ...
  { id: 'community',   label: 'Community',    watermark: 'COMMUNITY', accent: '#e8b830', dim: '#e8b83016' },
  { id: 'marketplace', label: 'Marketplace',  watermark: 'MARKET',    accent: '#f0c040', dim: '#f0c04018' },
  ...
  { id: 'editorial',   label: 'Editorial',    watermark: 'STORIES',   accent: '#ffd84a', dim: '#ffd84a16' },
] as const;
...
function HubCard({ card, isAuthed, accent }: { card: HubCardData; isAuthed: boolean; accent: string }) {
  ...
  return (
    <motion.div variants={cardVariants}>
      ...
      >
        <motion.div
          whileHover={{ y: -4, boxShadow: locked ? 'none' : `0 8px 32px ${accent}22, 0 0 0 1px ${accent}33` }}
          whileTap={{ scale: 0.98 }}
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', gap: space[2], alignItems: 'center' }}>
              ...
              {locked && (
                <span aria-label="requires sign in" style={{ fontSize: 11, opacity: 0.35 }}>🔒</span>
              )}
            </div>
          </div>
