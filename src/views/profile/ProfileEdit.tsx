  ...
  const fetchProfile = async () => {
    try {
      ...
      const mockProfile: ProfileData = {
        ...
        bio: 'Spinning the best techno and house music in the underground scene.',
      ...
      setSelectedGenres(mockProfile.genres);
    } catch (err) {
    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-yellow-400 mb-2">Edit Your Profile</h1>
          <p className="text-gray-400">Update your DJ profile information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              onClick={() => navigate(`/u/${formData.username}`)}
